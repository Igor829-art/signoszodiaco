...
function ListaDeSignos(){
    return (
        <div>
            ...
            <div className="Lista">
                <ItemLista signo="Aquário" dataInicio="21/01" dataFim="19/02" imagem="assets/aquario.jpg" />
                ...
                <ItemLista signo="Gêmeos"  dataInicio="22/05" dataFim="21/06" imagem="assets/gemeos.jpg" />
                ...
                <ItemLista signo="Sagitário"     dataInicio="24/11" dataFim="23/12" imagem="assets/sagitario.jpg" />
                <ItemLista signo="Capricórnio"   dataInicio="24/12" dataFim="20/01" imagem="assets/capricornio.jpg" />
            </div>
        </div>
    );
}
